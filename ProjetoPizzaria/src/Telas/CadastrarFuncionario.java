...
public class CadastrarFuncionario extends javax.swing.JFrame {
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        try{
            ...
            PreparedStatement st = conectado.prepareStatement("INSERT INTO funcionario(nome_funcionario, senha_funcionario, cpf_funcionario, cargo_funcionario, celular_funcionario) values(?, ?, ?, ?, ?)");
            st.setString(1, n);
            st.setString(2, s);
            st.setString(3, cpf);
            st.setString(4, car);
