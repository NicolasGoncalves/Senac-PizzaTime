...
public class ListarBebida extends javax.swing.JFrame {
    ...
    public void carregarDados(){
        ...
        try{
            ...
            PreparedStatement st = conectado.prepareStatement("SELECT * FROM bebida");
            ResultSet bebida = st.executeQuery();
            DefaultTableModel tblModelo = (DefaultTableModel) tblBebida.getModel();
            ...
            while(bebida.next()){
                ...
                Object nomes[] = {"", "", ""};
                Object linha[] = {
                    bebida.getString("nome_bebida"),
                    bebida.getString("preco_bebida"),
                    bebida.getString("tipo_bebida")
                };
    ...
    private void initComponents() {
        ...
        txtTipoBebida = new javax.swing.JTextField();
        ...
        txtTipoBebida.setBounds(20, 110, 220, 30);
        ...
        setSize(new java.awt.Dimension(655, 611));
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        try{
            ...
            PreparedStatement st = conectado.prepareStatement("SELECT * FROM bebida WHERE tipo_bebida = ?");
            st.setString(1, t);
    ...
    private javax.swing.JTextField txtTipoBebida;
