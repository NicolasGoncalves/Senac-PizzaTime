...
public class AlterarBebida extends javax.swing.JFrame {
    ...
    public AlterarBebida(String nom, String pre, String tip){
        initComponents();
        txtNome.setText(nom);
    ...
    private void initComponents() {
        ...
        btnSalvar.setBounds(190, 260, 150, 40);
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        try {
            ...
            PreparedStatement st = conectado.prepareStatement("UPDATE bebida SET nome_bebida = ?, preco_bebida = ?, tipo_bebida = ? WHERE nome_bebida = ?");
            st.setString(1, nom);
            st.setString(2, pre);
            st.setString(3, tip);
            st.setString(4, nom);
